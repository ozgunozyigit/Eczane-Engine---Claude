...
const LISTE_DISI_BASLANGICLAR_RAW = [
  ...
  "VERISCA","WEE","MAVIINTRAKET","NIRVANAIDRARTORBASI","COLASTINMAXIFORM","CONTOUR","PROSAFEPHARMAEMICIKULOT","MOODMATE",
  "OPTIMABLOOD","ACCUCHECKACTIVE","EVOLVIARP","VIVACHEKSTRIP"
]
